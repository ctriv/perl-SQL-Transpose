...
sub show_form {
    ...
    print $q->header,
        ...
        $q->h1(qq[<a href="http://sqlfairy.sourceforge.net">$title</a>]), $q->start_form(-enctype => 'multipart/form-data'), $q->table(
        {-border => 1},
            ...
            $q->td(
                [
                    ...
                    $q->radio_group(
                        -name   => 'producer',
                        -values => [
                            qw[ ClassDBI Diagram GraphViz HTML
            ...
            $q->td(
                [
                    ...
                    $q->radio_group(
                        ...
                        -values => [
                            qw( canon text ps hpgl pcl mif pic
