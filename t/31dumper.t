...
BEGIN {
    maybe_plan(5, 'DBI', 'SQL::Transpose::Parser::SQLite', 'SQL::Transpose::Producer::Dumper');
}
...
like($output, qr{DBI->connect\(\s*'$dsn',\s*'$db_user',\s*'$db_pass',}, 'Script contains correct DSN, db user and password');
