...
BEGIN {
    maybe_plan(10, 'SQL::Transpose::Producer::PostgreSQL', 'Test::Differences',);
}
...
is(
    $field1_geocon, qq[ALTER TABLE "my'table" ADD CONSTRAINT "enforce_dims_myfield" CHECK ((ST_NDims("myfield") = 2));
...
my $alter_field = SQL::Transpose::Producer::PostgreSQL->alter_field($field1, $field2, $options);
is(
    $alter_field, qq[DELETE FROM geometry_columns WHERE f_table_schema = 'myschema' AND f_table_name = 'my''table' AND f_geometry_column = 'myfield';
...
my $alter_field2 = SQL::Transpose::Producer::PostgreSQL->alter_field($field2, $field1, $options);
is(
    $alter_field2, qq[ALTER TABLE "my'table" ALTER COLUMN "myfield" DROP NOT NULL;
...
is(
    $add_field, qq[ALTER TABLE "my'table" ADD COLUMN "field3" geometry;
...
is(
    $drop_field, qq[ALTER TABLE "my'table" DROP COLUMN "field3";
...
is(
    $rename_table, qq[ALTER TABLE "my'table" RENAME TO "table2";
DELETE FROM geometry_columns WHERE f_table_schema = 'myschema' AND f_table_name = 'my''table' AND f_geometry_column = 'field3';
...
is(
    $drop_table, qq[DROP TABLE "table2" CASCADE;
