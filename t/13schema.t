...

{
    ...
    my $bar_table = SQL::Transpose::Schema::Table->new(name => 'bar')
        or warn SQL::Transpose::Schema::Table->error;
    ...
    like(SQL::Transpose::Schema::Table->error, qr/No table name/i, '... because it has no name ');
    ...
    like(SQL::Transpose::Schema::Field->error, qr/No field name/i, '... because it has no name');
    ...
    ok(ref $fields[0] && $fields[0]->isa("SQL::Transpose::Schema::Field"), 'Constraint fields returns a SQL::Transpose::Schema::Field');
    ...
    my $view2 = SQL::Transpose::Schema::View->new(name => 'view2')
        or warn SQL::Transpose::Schema::View->error;
