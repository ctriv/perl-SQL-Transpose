package SQL::Transpose::Schema;

=pod

=head1 NAME

SQL::Transpose::Schema - SQL::Transpose schema object
...
C<SQL::Transpose::Schema> is the object that accepts, validates, and
...
use SQL::Transpose::Schema::Procedure;
use SQL::Transpose::Schema::Table;
use SQL::Transpose::Schema::Trigger;
use SQL::Transpose::Schema::View;
use Sub::Quote qw(quote_sub);

use SQL::Transpose::Utils 'parse_list_arg';
use Carp;
...
Add a table object.  Returns the new SQL::Transpose::Schema::Table object.
...
not be created.
  ...
  my $t2 = SQL::Transpose::Schema::Table->new( name => 'bar' );
...
name or an C<SQL::Transpose::Schema::Table> object. The "cascade" parameter
...
Add a procedure object.  Returns the new SQL::Transpose::Schema::Procedure
...
procedure will not be created.
  ...
  my $p2 = SQL::Transpose::Schema::Procedure->new( name => 'bar' );
...
can be either a procedure name or an C<SQL::Transpose::Schema::Procedure>
object.
...
Add a trigger object.  Returns the new SQL::Transpose::Schema::Trigger object.
...
not be created.
  ...
  my $t2 = SQL::Transpose::Schema::Trigger->new( name => 'bar' );
...
trigger name or an C<SQL::Transpose::Schema::Trigger> object.
...
Add a view object.  Returns the new SQL::Transpose::Schema::View object.
...
not be created.
  ...
  my $v2 = SQL::Transpose::Schema::View->new( name => 'bar' );
...
name or an C<SQL::Transpose::Schema::View> object.
...
Get the SQL::Transpose instance that instantiated the parser.
