package SQL::Transpose::Parser::xSV;

=head1 NAME

SQL::Transpose::Parser::xSV - parser for arbitrarily delimited text files

=head1 SYNOPSIS

  use SQL::Transpose;
  use SQL::Transpose::Parser::xSV;
...
C<SQL::Transpose::Utils::normalize_name>.
...
Text::RecordParser, SQL::Transpose.
