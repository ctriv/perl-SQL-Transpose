package SQL::Transpose::Parser::DBI::Oracle;

=head1 NAME

SQL::Transpose::Parser::DBI::Oracle - parser for DBD::Oracle
...
SQL::Transpose::Parser::DBI::PostgreSQL revision 1.7
