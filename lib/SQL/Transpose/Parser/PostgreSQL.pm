package SQL::Transpose::Parser::PostgreSQL;

=head1 NAME

SQL::Transpose::Parser::PostgreSQL - parser for PostgreSQL

=head1 SYNOPSIS

  use SQL::Transpose;
  use SQL::Transpose::Parser::PostgreSQL;

  my $translator = SQL::Transpose->new;
  $translator->parser("SQL::Transpose::Parser::PostgreSQL");
