package SQL::Transpose::Parser::YAML;
...
SQL::Transpose::Parser::YAML - Parse a YAML representation of a schema

=head1 SYNOPSIS

    use SQL::Transpose;

    my $translator = SQL::Transpose->new(parser => "YAML");

=head1 DESCRIPTION

C<SQL::Transpose::Parser::YAML> parses a schema serialized with YAML.
