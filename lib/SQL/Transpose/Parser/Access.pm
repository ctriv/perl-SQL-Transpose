package SQL::Transpose::Parser::Access;

=head1 NAME

SQL::Transpose::Parser::Access - parser for Access as produced by mdbtools
...
=head1 SYNOPSIS
  ...
  $translator->parser("SQL::Transpose::Parser::Access");
...
perl(1), Parse::RecDescent, SQL::Transpose::Schema.
