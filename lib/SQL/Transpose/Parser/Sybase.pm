package SQL::Transpose::Parser::Sybase;

=head1 NAME

SQL::Transpose::Parser::Sybase - parser for Sybase

=head1 SYNOPSIS

  use SQL::Transpose::Parser::Sybase;
...
DBI-Sybase parser included with SQL::Transpose.
...
SQL::Transpose, SQL::Transpose::Parser::DBI, L<http://www.midsomer.org/>.
