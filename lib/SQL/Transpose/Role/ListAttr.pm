package SQL::Transpose::Role::ListAttr;
...
SQL::Transpose::Role::ListAttr - context-sensitive list attributes
...
use SQL::Transpose::Utils qw(parse_list_arg ex2err uniq);
...
L<SQL::Transpose::Utils/parse_list_arg>, and the accessor will return
