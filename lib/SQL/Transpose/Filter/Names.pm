package SQL::Transpose::Filter::Names;

=head1 NAME

SQL::Transpose::Filter::Names - Tweak the names of schema objects.
...
=head1 SYNOPSIS
  ...
  ) || die "SQLFairy error : ".SQL::Transpose->error;
...
sub _getfunc {
    my ($name) = @_;
    no strict 'refs';
    my $func = "SQL::Transpose::Filter::Names::$name";
