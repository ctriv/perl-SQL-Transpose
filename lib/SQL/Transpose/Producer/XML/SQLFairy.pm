package SQL::Transpose::Producer::XML::SQLFairy;

=pod

=head1 NAME

SQL::Transpose::Producer::XML::SQLFairy - SQLFairy's default XML format
...
SQLFairy project (L<SQL::Transpose>). This format is detailed here.
...
use SQL::Transpose::Utils qw(header_comment debug);
...
C<perl(1)>, L<SQL::Transpose>, L<SQL::Transpose::Parser::XML::SQLFairy>,
L<SQL::Transpose::Schema>, L<XML::Writer>.
