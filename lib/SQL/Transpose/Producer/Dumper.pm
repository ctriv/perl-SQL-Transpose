package SQL::Transpose::Producer::Dumper;

=head1 NAME

SQL::Transpose::Producer::Dumper - SQL Dumper producer for SQL::Transpose

=head1 SYNOPSIS

  use SQL::Transpose::Producer::Dumper;
