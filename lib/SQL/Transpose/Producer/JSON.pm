package SQL::Transpose::Producer::JSON;

=head1 NAME

SQL::Transpose::Producer::JSON - A JSON producer for SQL::Transpose

=head1 SYNOPSIS

  use SQL::Transpose;

  my $translator = SQL::Transpose->new(producer => 'JSON');
...
SQL::Transpose, JSON, http://www.json.org/.
