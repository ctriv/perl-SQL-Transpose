package SQL::Transpose::Producer::GraphViz;

=pod

=head1 NAME

SQL::Transpose::Producer::GraphViz - GraphViz producer for SQL::Transpose

=head1 SYNOPSIS

  use SQL::Transpose;

  my $trans = SQL::Transpose->new(
...
If set to a true value, L<SQL::Transpose::Schema/make_natural_joins>
will be called before generating the graph.

=item * join_pk_only

The value of this option will be passed as the value of the
like-named argument to L<SQL::Transpose::Schema/make_natural_joins>;
