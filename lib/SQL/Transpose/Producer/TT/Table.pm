package SQL::Transpose::Producer::TT::Table;

=pod

=head1 NAME

SQL::Transpose::Producer::TT::Table -
...
L<SQL::Transpose::Schema::Table> table we are producing,
...
L<SQL::Transpose::Schema> for the table and C<translator>,
the L<SQL::Transpose> object for this parse in case you want to get
...
- Integrate with L<TT::Base|SQL::Transpose::Producer::TT::Base> and
  L<TTSchema|SQL::Transpose::Producer::TTSchema>.
