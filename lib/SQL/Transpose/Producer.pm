package SQL::Transpose::Producer;
...
SQL::Transpose::Producer - describes how to write a producer

=head1 DESCRIPTION

Producer modules designed to be used with SQL::Transpose need to
implement a single function, called B<produce>.  B<produce> will be
called with the SQL::Transpose object from which it is expected to
retrieve the SQL::Transpose::Schema object which has been populated
