package SQL::Transpose::Schema::Procedure;

=pod

=head1 NAME

SQL::Transpose::Schema::Procedure - SQL::Transpose procedure object
...
C<SQL::Transpose::Schema::Procedure> is a class for dealing with
...
use Moo;
use SQL::Transpose::Utils qw(ex2err);
...
Object constructor.
  ...
  my $schema = SQL::Transpose::Schema::Procedure->new;
