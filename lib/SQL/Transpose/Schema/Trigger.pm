package SQL::Transpose::Schema::Trigger;

=pod

=head1 NAME

SQL::Transpose::Schema::Trigger - SQL::Transpose trigger object

=head1 SYNOPSIS

  use SQL::Transpose::Schema::Trigger;
  my $trigger = SQL::Transpose::Schema::Trigger->new(
    name                => 'foo',
...
C<SQL::Transpose::Schema::Trigger> is the trigger object.
...
use Moo;
use SQL::Transpose::Utils qw(parse_list_arg ex2err throw uniq);
...
Object constructor.
  ...
  my $schema = SQL::Transpose::Schema::Trigger->new;
...
Gets or set the table on which the trigger works, as a L<SQL::Transpose::Schema::Table> object.
