package SQL::Transpose::Schema::Role::Compare;

=head1 NAME

SQL::Transpose::Schema::Role::Compare - compare objects

=head1 SYNOPSIS

    package Foo;
    use Moo;
	with qw(SQL::Transpose::Schema::Role::Compare);
...
sub _compare_objects {
    ...
    my $result = (Data::Dumper->new([$_[1]])->Terse(1)->Indent(0)->Deparse(1)->Sortkeys(1)->Maxdepth(0)->Dump eq
