package SQL::Transpose::Schema::View;

=pod

=head1 NAME

SQL::Transpose::Schema::View - SQL::Transpose view object

=head1 SYNOPSIS

  use SQL::Transpose::Schema::View;
  my $view   = SQL::Transpose::Schema::View->new(
...
C<SQL::Transpose::Schema::View> is the view object.
