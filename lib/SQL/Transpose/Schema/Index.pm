package SQL::Transpose::Schema::Index;

=pod

=head1 NAME

SQL::Transpose::Schema::Index - SQL::Transpose index object

=head1 SYNOPSIS

  use SQL::Transpose::Schema::Index;
  my $index = SQL::Transpose::Schema::Index->new(
      name   => 'foo',
      fields => [ id ],
      type   => 'unique',
  );
...
C<SQL::Transpose::Schema::Index> is the index object.
...
Object constructor.
  ...
  my $schema = SQL::Transpose::Schema::Index->new;
...
=cut
    ...
    foreach my $field (@fields) {
        return $self->error("Field '$field' does not exist in table '", $table->name, "'") unless $table->get_field($field);
    }
