...
sub _list {
    ...
    #
    # First find all the directories where SQL::Transpose
    # parsers or producers (the "type") appear to live.
    #
    load("SQL::Transpose::$uctype") or return ();
...
# (\&code, $sub) = load_sub( 'MySQL::produce', "SQL::Transpose::Producer" );
...
SQL::Transpose - manipulate structured data definitions (SQL and more)
...
This documentation covers the API for SQL::Transpose.  For a more general
discussion of how to use the modules and scripts, please see
L<SQL::Transpose::Manual>.

SQL::Transpose is a group of Perl modules that converts
...
XML, and Class::DBI classes.  The main focus of SQL::Transpose is
...
and passed its container C<SQL::Transpose> instance, which it should
call the C<schema> method on, to get the C<SQL::Transpose::Schema>
generated by the parser.  It is expected that the function transform the
schema structure to a string.  The C<SQL::Transpose> instance is also useful
...
the C<SQL::Transpose::Producer> namespace (e.g., C<MySQL>), a module
...
F<My/Groovy/Producer/transmogrify.pm>, C<SQL::Transpose> will attempt
...
the function, instead of the default C<produce>.
  ...
  # This will invoke SQL::Transpose::Producer::Sybase::produce($tr, $data)
  $tr->producer("Sybase");
...
entirety of the data to be parsed.
  ...
  # Invokes SQL::Transpose::Parser::MySQL::parse()
  $tr->parser("MySQL");
...
module name relative to the SQL::Transpose::Filter namespace, a module
...
Returns the SQL::Transpose::Schema object.
...
Returns the version of the SQL::Transpose release.
...
Copyright 2012 the SQL::Transpose authors, as listed in L</AUTHORS>.
...
L<perl>,
L<SQL::Transpose::Parser>,
L<SQL::Transpose::Producer>,
L<Parse::RecDescent>,
L<GD>,
L<GraphViz>,
L<Text::RecordParser>,
